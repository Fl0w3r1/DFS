...
def ektelesi():
    ...
    g.add_edge(Edge(komvoi["G"],komvoi["D"]))
    ...
    g.add_edge(Edge(komvoi["A"],komvoi["D"]))
    g.add_edge(Edge(komvoi["A"],komvoi["G"]))
    g.add_edge(Edge(komvoi["A"],komvoi["H"]))
    g.add_edge(Edge(komvoi["A"],komvoi["Θ"]))
    g.add_edge(Edge(komvoi["B"],komvoi["D"]))
    g.add_edge(Edge(komvoi["B"],komvoi["E"]))
    g.add_edge(Edge(komvoi["B"],komvoi["G"]))
    g.add_edge(Edge(komvoi["B"],komvoi["Z"]))
    g.add_edge(Edge(komvoi["B"],komvoi["H"]))
    g.add_edge(Edge(komvoi["B"],komvoi["K"]))
    g.add_edge(Edge(komvoi["G"],komvoi["D"]))
    g.add_edge(Edge(komvoi["G"],komvoi["E"]))
    g.add_edge(Edge(komvoi["G"],komvoi["Θ"]))
    g.add_edge(Edge(komvoi["G"],komvoi["I"]))
    g.add_edge(Edge(komvoi["D"],komvoi["E"]))
    g.add_edge(Edge(komvoi["E"],komvoi["A"]))
    g.add_edge(Edge(komvoi["E"],komvoi["Z"]))
    g.add_edge(Edge(komvoi["E"],komvoi["I"]))
    g.add_edge(Edge(komvoi["E"],komvoi["K"]))
    g.add_edge(Edge(komvoi["Z"],komvoi["B"]))
    g.add_edge(Edge(komvoi["Z"],komvoi["E"]))
    g.add_edge(Edge(komvoi["H"],komvoi["A"]))
    g.add_edge(Edge(komvoi["H"],komvoi["B"]))
    g.add_edge(Edge(komvoi["Θ"],komvoi["A"]))
    g.add_edge(Edge(komvoi["Θ"],komvoi["G"]))
    g.add_edge(Edge(komvoi["I"],komvoi["G"]))
    g.add_edge(Edge(komvoi["I"],komvoi["E"]))
    g.add_edge(Edge(komvoi["K"],komvoi["B"]))
    g.add_edge(Edge(komvoi["K"],komvoi["E"]))
    """
